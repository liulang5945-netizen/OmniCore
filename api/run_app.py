"""
OmniCore 启动入口（兼容 PyInstaller 打包）
...
from core.config import apply_env_overrides, get_external_path, get_internal_path, get_writable_base_dir
...
class Worker(QObject):
    ...
    def run(self):
        try:
            ...
            import json
            from core.config import MODEL_LOAD_TIMEOUT
...
class MainWindow(QMainWindow):
    ...
    def toggle_devtools(self):
        if not hasattr(self, 'dev_window'):
            ...
            self.dev_window.setWindowTitle("OmniCore 开发者工具 (F12)")
...
def _real_main():
    ...
    app.setApplicationName("OmniCore")
    app.setOrganizationName("OmniCore")
    app.setOrganizationDomain("omnicore.local")
    ...
    def on_loading_complete(local_url):
        ...
        window = MainWindow()
        window.setWindowTitle("OmniCore 智核工作站")
        ...
        tray_icon.setToolTip("OmniCore 智核工作站 (后台运行)")
...
if __name__ == "__main__":
    ...
    try:
        ...
        try:
            ...
            _msg.setWindowTitle("OmniCore 启动失败")
