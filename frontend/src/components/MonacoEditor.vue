  ...
  <div class="monaco-wrapper">
    <div class="monaco-toolbar">
      ...
      <div class="monaco-actions">
        <select v-model="language" class="lang-select" @change="updateLanguage">
...
.monaco-toolbar { display: flex; align-items: center; background: var(--bg); border-bottom: 1px solid var(--border); padding: 0 8px; min-height: 36px; gap: 4px; }
.monaco-tabs { display: flex; flex: 1; overflow-x: auto; gap: 1px; }
.monaco-tab { display: flex; align-items: center; gap: 4px; padding: 6px 12px; background: transparent; border: none; color: var(--text-muted); cursor: pointer; font-size: 12px; white-space: nowrap; border-bottom: 2px solid transparent; transition: all 0.15s ease; border-radius: 4px 4px 0 0; }
...
.monaco-actions { display: flex; gap: 6px; align-items: center; margin-left: 8px; }
.lang-select { background: var(--bg-card); color: var(--text-secondary); border: 1px solid var(--border); padding: 2px 6px; border-radius: 4px; font-size: 11px; outline: none; }
.lang-select:focus { border-color: var(--primary); }
.btn-action { background: transparent; border: 1px solid transparent; cursor: pointer; font-size: 14px; padding: 3px 6px; border-radius: 4px; transition: all 0.15s ease; }
